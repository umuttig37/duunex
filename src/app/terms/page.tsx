...
export const metadata: Metadata = {
  title: 'Käyttöehdot | TaskMVP',
  description: 'TaskMVP:n palvelun käyttöehdot.',
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mb-4 text-gray-700">
        Tämä sivu kuvaa TaskMVP-palvelun käyttöehdot. Päivitämme ehtoja tarpeen mukaan.
      </p>
      <h2 className="mt-8 mb-2 text-xl font-semibold">1. Palvelun kuvaus</h2>
      <p className="text-gray-700">
        TaskMVP on markkinapaikka, jossa asiakkaat voivat julkaista tehtäviä ja tekijät tarjota palveluitaan.
      </p>
