...
export const metadata: Metadata = {
  ...
  description: 'Tietoja henkilötietojen käsittelystä Duunex-palvelussa.',
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mb-4 text-gray-700">
        Tässä kuvataan, miten keräämme, käytämme ja suojaamme henkilötietoja Duunex-palvelussa.
      </p>
      <h2 className="mt-8 mb-2 text-xl font-semibold">1. Rekisterinpitäjä</h2>
      <p className="text-gray-700">Duunex Oy, Helsinki, Suomi. Yhteys: info@duunex.fi</p>
