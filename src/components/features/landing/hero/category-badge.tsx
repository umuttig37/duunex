  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-card border border-border touch-manipulation flex-shrink-0",
    ...
    >
      {/* Icon */}
      <div className={cn(
        "flex items-center hover:bg-primary/10 hover:text-primary transition-all duration-200 justify-center w-12 h-12 sm:w-16 sm:h-14 lg:w-20 lg:h-16 rounded-lg mb-1 sm:mb-2",
        isActive 
